...
If used on a foldable screen, it is necessary to add recalculateHiddenLayout to true to prevent the loss of components from the unfolded to folded state of the foldable screen.
